...
public class IngestInterimJob implements Action<Phases, Events> {

    @Override
    public void execute(StateContext<Phases, Events> context) {
        System.out.print("Executing Ingest Interim...");
        try {
            Thread.sleep(1000);
        ...
        System.out.println();
        context.getStateMachine().sendEvent(Events.DONE_INTERIM);
    }
}
